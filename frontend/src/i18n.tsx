...
const DICT: Dict = {
  ...
  "portal.submit": { ru: "Отправить предложение заказчику", en: "Submit proposal to owner" },
  "portal.submitted": { ru: "Предложение отправлено. Изменения закрыты.", en: "Proposal submitted. Editing is locked." },
  "portal.submitOk": { ru: "Предложение успешно отправлено", en: "Proposal submitted successfully" },
  "portal.submitConfirm": { ru: "Отправить предложение? После отправки изменения будут недоступны.", en: "Submit the proposal? After submission editing is locked." },
  "portal.incomplete": { ru: "Не заполнено. Допишите перед отправкой:", en: "Incomplete. Complete before submitting:" },
  "portal.missPrices": { ru: "Нет цены по позициям", en: "Missing prices for items" },
  "portal.missReq": { ru: "Нет ответа/файла по пунктам", en: "Missing answer/file for items" },
  ...
  "vend.fLr": { ru: "Ответственный (LR)", en: "Responsible (LR)" },
  "vend.fLrPlaceholder": { ru: "Кому летят вопросы подрядчиков", en: "Receives vendor questions" },
